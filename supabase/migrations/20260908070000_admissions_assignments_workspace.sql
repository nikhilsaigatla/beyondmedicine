...
CREATE TABLE public.admissions_assignments (
...
CREATE TABLE public.admissions_assignment_targets (
...
CREATE TABLE public.admissions_assignment_submissions (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  assignment_id uuid NOT NULL REFERENCES public.admissions_assignments(id) ON DELETE CASCADE,
  user_id uuid NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
...
CREATE INDEX admissions_assignments_status_due_idx ON public.admissions_assignments (status, due_at);
CREATE INDEX admissions_assignments_target_status_idx ON public.admissions_assignments (target_status);
CREATE INDEX admissions_assignment_targets_user_idx ON public.admissions_assignment_targets (user_id);
CREATE INDEX admissions_submissions_assignment_idx ON public.admissions_assignment_submissions (assignment_id);
CREATE INDEX admissions_submissions_user_status_idx ON public.admissions_assignment_submissions (user_id, status);
